 ...
 */
class PageObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageObjectCollection $proxy) {
