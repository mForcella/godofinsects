 ...
 */
class BlockTypeSet extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BlockTypeSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'name', 'package', 'types'];
        }
