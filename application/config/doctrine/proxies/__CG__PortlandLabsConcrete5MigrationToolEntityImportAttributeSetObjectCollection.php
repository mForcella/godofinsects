 ...
 */
class AttributeSetObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeSetObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeSetObjectCollection $proxy) {
