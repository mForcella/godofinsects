 ...
 */
class AttributeSet extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'name', 'category', 'package', 'is_locked', 'attributes'];
        }
