 ...
 */
class ContentEditorSnippet extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\ContentEditorSnippet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'name', 'is_activated', 'package'];
        }
    ...
    public function setIsActivated($is_activated)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsActivated', [$is_activated]);

        return parent::setIsActivated($is_activated);
    }
