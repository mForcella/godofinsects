 ...
 */
class PageTypeComposerControlType extends \PortlandLabs\Concrete5\MigrationTool\Entity\Export\PageTypeComposerControlType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'item_id', 'id', 'collection'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageTypeComposerControlType $proxy) {
