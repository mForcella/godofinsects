 ...
 */
class StandardBlockValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BlockValue\StandardBlockValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StandardBlockValue $proxy) {
