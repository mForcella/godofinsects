 ...
 */
class BlockTypeObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BlockTypeObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlockTypeObjectCollection $proxy) {
