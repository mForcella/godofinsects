 ...
 */
class GroupAccessEntity extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Permission\GroupAccessEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'group_name', 'key', 'entity_type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupAccessEntity $proxy) {
    ...
    public function setGroupName($group_name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGroupName', [$group_name]);

        return parent::setGroupName($group_name);
    }
    ...
    public function setEntityType($entity_type)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEntityType', [$entity_type]);
