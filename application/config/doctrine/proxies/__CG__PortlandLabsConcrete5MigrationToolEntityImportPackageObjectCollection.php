 ...
 */
class PackageObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PackageObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['packages' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'packages', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PackageObjectCollection $proxy) {
