 ...
 */
class BooleanAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\BooleanAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'is_checked', 'id', 'collection', 'handle', 'category', 'name', 'is_searchable', 'is_internal', 'is_indexed', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BooleanAttributeKey $proxy) {
    ...
    public function getIsChecked()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsChecked', []);

        return parent::getIsChecked();
    }
    ...
    public function setIsChecked($is_checked)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsChecked', [$is_checked]);

        return parent::setIsChecked($is_checked);
    }
