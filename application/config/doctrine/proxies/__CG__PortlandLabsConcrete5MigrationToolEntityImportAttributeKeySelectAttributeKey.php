 ...
 */
class SelectAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\SelectAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'allow_multiple_values', 'allow_other_values', 'display_order', 'options', 'id', 'collection', 'handle', 'category', 'name', 'is_searchable', 'is_internal', 'is_indexed', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SelectAttributeKey $proxy) {
    ...
    public function setAllowMultipleValues($allow_multiple_values)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAllowMultipleValues', [$allow_multiple_values]);

        return parent::setAllowMultipleValues($allow_multiple_values);
    }
    ...
    public function setAllowOtherValues($allow_other_values)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAllowOtherValues', [$allow_other_values]);

        return parent::setAllowOtherValues($allow_other_values);
    }
