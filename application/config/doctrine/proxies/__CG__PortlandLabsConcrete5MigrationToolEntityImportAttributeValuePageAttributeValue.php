 ...
 */
class PageAttributeValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeValue\PageAttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageAttributeValue $proxy) {
    ...
    public function setValue($page_value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue', [$page_value]);

        return parent::setValue($page_value);
    }
