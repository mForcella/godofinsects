 ...
 */
class ThumbnailType extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\ThumbnailType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'name', 'width', 'height', 'is_required'];
        }
