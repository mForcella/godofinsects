 ...
 */
class BlockTypeSetObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BlockTypeSetObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['sets' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'sets', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlockTypeSetObjectCollection $proxy) {
