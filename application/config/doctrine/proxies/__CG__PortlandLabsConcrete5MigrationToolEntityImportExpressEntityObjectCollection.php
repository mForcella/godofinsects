 ...
 */
class EntityObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Express\EntityObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['entities' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entities', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EntityObjectCollection $proxy) {
