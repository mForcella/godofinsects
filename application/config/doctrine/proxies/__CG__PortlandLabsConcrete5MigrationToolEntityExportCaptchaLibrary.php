 ...
 */
class CaptchaLibrary extends \PortlandLabs\Concrete5\MigrationTool\Entity\Export\CaptchaLibrary implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'handle', 'id', 'collection'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CaptchaLibrary $proxy) {
