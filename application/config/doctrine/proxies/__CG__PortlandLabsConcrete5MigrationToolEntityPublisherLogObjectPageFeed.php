 ...
 */
class PageFeed extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\Object\PageFeed implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'title', 'handle', 'id', 'entry'];
        }
