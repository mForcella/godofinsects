 ...
 */
class ParentPagePublishTarget extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageType\ParentPagePublishTarget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'path', 'id', 'type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ParentPagePublishTarget $proxy) {
