 ...
 */
class UserAccessEntity extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Permission\UserAccessEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user_name', 'key', 'entity_type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserAccessEntity $proxy) {
