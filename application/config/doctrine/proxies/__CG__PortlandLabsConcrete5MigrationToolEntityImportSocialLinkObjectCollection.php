 ...
 */
class SocialLinkObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\SocialLinkObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['links' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'links', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SocialLinkObjectCollection $proxy) {
