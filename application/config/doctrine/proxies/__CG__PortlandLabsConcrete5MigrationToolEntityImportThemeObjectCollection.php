 ...
 */
class ThemeObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\ThemeObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['themes' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'themes', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ThemeObjectCollection $proxy) {
