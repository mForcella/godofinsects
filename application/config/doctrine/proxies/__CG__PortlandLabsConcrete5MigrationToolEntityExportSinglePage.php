 ...
 */
class SinglePage extends \PortlandLabs\Concrete5\MigrationTool\Entity\Export\SinglePage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SinglePage $proxy) {
