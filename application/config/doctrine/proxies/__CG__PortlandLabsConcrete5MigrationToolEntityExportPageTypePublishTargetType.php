 ...
 */
class PageTypePublishTargetType extends \PortlandLabs\Concrete5\MigrationTool\Entity\Export\PageTypePublishTargetType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageTypePublishTargetType $proxy) {
