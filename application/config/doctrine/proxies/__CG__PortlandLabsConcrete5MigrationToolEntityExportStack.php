 ...
 */
class Stack extends \PortlandLabs\Concrete5\MigrationTool\Entity\Export\Stack implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'stack_type', 'item_id', 'id', 'collection'];
        }
    ...
    public function getStackType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStackType', []);
    ...
    public function setStackType($stack_type)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStackType', [$stack_type]);

        return parent::setStackType($stack_type);
    }
