 ...
 */
class UnknownAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\UnknownAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'options_xml', 'id', 'collection', 'handle', 'category', 'name', 'is_searchable', 'is_internal', 'is_indexed', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UnknownAttributeKey $proxy) {
    ...
    public function getOptionsXml()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOptionsXml', []);

        return parent::getOptionsXml();
    }
    ...
    public function setOptionsXml($options_xml)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOptionsXml', [$options_xml]);

        return parent::setOptionsXml($options_xml);
    }
