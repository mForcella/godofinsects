 ...
 */
class ConfigValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\ConfigValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'config_key', 'config_value', 'package'];
        }
    ...
    public function setConfigKey($key)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setConfigKey', [$key]);

        return parent::setConfigKey($key);
    }
    ...
    public function setConfigValue($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setConfigValue', [$value]);

        return parent::setConfigValue($value);
    }
