 ...
 */
class UserGroup extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\UserGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'name', 'path'];
        }
