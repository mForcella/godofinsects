 ...
 */
class TopicsAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\TopicsAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'tree_name', 'node_path', 'id', 'collection', 'handle', 'category', 'name', 'is_searchable', 'is_internal', 'is_indexed', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TopicsAttributeKey $proxy) {
    ...
    public function setTreeName($tree_name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTreeName', [$tree_name]);

        return parent::setTreeName($tree_name);
    }
    ...
    public function getNodePath()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNodePath', []);
    ...
    public function setNodePath($node_path)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNodePath', [$node_path]);

        return parent::setNodePath($node_path);
    }
