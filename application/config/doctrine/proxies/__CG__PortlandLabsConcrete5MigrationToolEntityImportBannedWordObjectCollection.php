 ...
 */
class BannedWordObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BannedWordObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['words' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'words', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BannedWordObjectCollection $proxy) {
