 ...
 */
class AssociationControl extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Express\AssociationControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'association', 'id', 'field_set', 'is_required', 'position', 'custom_label'];
        }
