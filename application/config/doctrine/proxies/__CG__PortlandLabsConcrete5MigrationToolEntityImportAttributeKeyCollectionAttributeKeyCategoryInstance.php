 ...
 */
class CollectionAttributeKeyCategoryInstance extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\CollectionAttributeKeyCategoryInstance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CollectionAttributeKeyCategoryInstance $proxy) {
