 ...
 */
class ImportedBlockValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BlockValue\ImportedBlockValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'value', 'id', 'block'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImportedBlockValue $proxy) {
