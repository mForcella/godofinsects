 ...
 */
class SelectAttributeValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeValue\SelectAttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SelectAttributeValue $proxy) {
    ...
    public function setValue($select_value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue', [$select_value]);

        return parent::setValue($select_value);
    }
