 ...
 */
class PageTemplate extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'name', 'icon', 'package', 'is_internal'];
        }
