 ...
 */
class PageAttribute extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\Object\PageAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'handle', 'page', 'id', 'entry'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageAttribute $proxy) {
