 ...
 */
class SocialLink extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\Object\SocialLink implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'link', 'id', 'entry', 'service', 'url'];
        }
