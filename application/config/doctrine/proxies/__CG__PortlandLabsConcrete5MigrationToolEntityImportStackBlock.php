 ...
 */
class StackBlock extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\StackBlock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'area', 'stack', 'id', 'type', 'name', 'custom_template', 'block_value', 'style_set', 'position', 'defaults_output_identifier'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StackBlock $proxy) {
    ...
    public function getStack()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStack', []);
    ...
    public function setStack($stack)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStack', [$stack]);
