 ...
 */
class TextAreaAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\TextAreaAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'mode', 'id', 'collection', 'handle', 'category', 'name', 'is_searchable', 'is_internal', 'is_indexed', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextAreaAttributeKey $proxy) {
