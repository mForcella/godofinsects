 ...
 */
class SocialLinksAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\SocialLinksAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SocialLinksAttributeKey $proxy) {
