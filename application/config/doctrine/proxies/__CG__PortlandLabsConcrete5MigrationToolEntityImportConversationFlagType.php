 ...
 */
class FlagType extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Conversation\FlagType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FlagType $proxy) {
