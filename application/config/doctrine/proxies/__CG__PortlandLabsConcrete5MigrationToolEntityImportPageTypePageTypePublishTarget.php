 ...
 */
class PageTypePublishTarget extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageType\PageTypePublishTarget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'page_type', 'form_factor', 'id', 'type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageTypePublishTarget $proxy) {
    ...
    public function setFormFactor($form_factor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFormFactor', [$form_factor]);

        return parent::setFormFactor($form_factor);
    }
