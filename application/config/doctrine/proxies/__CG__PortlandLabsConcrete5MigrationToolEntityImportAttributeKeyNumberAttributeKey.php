 ...
 */
class NumberAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\NumberAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NumberAttributeKey $proxy) {
