 ...
 */
class AccessEntity extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Permission\AccessEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'key', 'entity_type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccessEntity $proxy) {
