 ...
 */
class RatingType extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Conversation\RatingType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'name', 'points', 'package'];
        }
