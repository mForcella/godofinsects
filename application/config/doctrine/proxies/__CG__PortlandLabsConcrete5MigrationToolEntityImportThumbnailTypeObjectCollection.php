 ...
 */
class ThumbnailTypeObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\ThumbnailTypeObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ThumbnailTypeObjectCollection $proxy) {
