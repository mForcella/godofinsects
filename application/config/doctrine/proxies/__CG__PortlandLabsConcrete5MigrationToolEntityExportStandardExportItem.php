 ...
 */
class StandardExportItem extends \PortlandLabs\Concrete5\MigrationTool\Entity\Export\StandardExportItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StandardExportItem $proxy) {
