 ...
 */
class AssociatedEntry extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Express\AssociatedEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'importID', 'association'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AssociatedEntry $proxy) {
