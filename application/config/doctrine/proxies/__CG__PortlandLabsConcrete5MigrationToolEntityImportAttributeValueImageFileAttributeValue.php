 ...
 */
class ImageFileAttributeValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeValue\ImageFileAttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageFileAttributeValue $proxy) {
    ...
    public function setValue($image_file_value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue', [$image_file_value]);

        return parent::setValue($image_file_value);
    }
