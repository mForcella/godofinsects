 ...
 */
class PageAttribute extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'attribute', 'page'];
        }
