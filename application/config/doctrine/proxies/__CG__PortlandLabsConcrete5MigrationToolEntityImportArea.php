 ...
 */
class Area extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['blocks' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'blocks', 'page', 'style_set', 'name'];
        }

        return ['__isInitialized__', 'id', 'page', 'style_set', 'name'];
    }
