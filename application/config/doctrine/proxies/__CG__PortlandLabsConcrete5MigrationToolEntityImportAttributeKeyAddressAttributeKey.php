 ...
 */
class AddressAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\AddressAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'default_country', 'has_custom_countries', 'custom_countries', 'id', 'collection', 'handle', 'category', 'name', 'is_searchable', 'is_internal', 'is_indexed', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AddressAttributeKey $proxy) {
    ...
    public function setDefaultCountry($default_country)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDefaultCountry', [$default_country]);

        return parent::setDefaultCountry($default_country);
    }
    ...
    public function getHasCustomCountries()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHasCustomCountries', []);

        return parent::getHasCustomCountries();
    }
    ...
    public function setHasCustomCountries($has_custom_countries)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHasCustomCountries', [$has_custom_countries]);

        return parent::setHasCustomCountries($has_custom_countries);
    }
    ...
    public function setCustomCountries($custom_countries)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomCountries', [$custom_countries]);

        return parent::setCustomCountries($custom_countries);
    }
