 ...
 */
class JobObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\JobObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['jobs' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'jobs', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JobObjectCollection $proxy) {
