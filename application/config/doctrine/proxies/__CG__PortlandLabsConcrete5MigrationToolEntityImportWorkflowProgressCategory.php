 ...
 */
class ProgressCategory extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Workflow\ProgressCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProgressCategory $proxy) {
