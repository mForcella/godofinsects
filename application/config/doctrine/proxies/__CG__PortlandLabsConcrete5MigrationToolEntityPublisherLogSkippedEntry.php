 ...
 */
class SkippedEntry extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\SkippedEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkippedEntry $proxy) {
