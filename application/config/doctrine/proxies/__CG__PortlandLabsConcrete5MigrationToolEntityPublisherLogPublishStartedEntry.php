 ...
 */
class PublishStartedEntry extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\PublishStartedEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PublishStartedEntry $proxy) {
