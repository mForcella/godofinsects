 ...
 */
class EntryAttribute extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Express\EntryAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'attribute', 'entry'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EntryAttribute $proxy) {
