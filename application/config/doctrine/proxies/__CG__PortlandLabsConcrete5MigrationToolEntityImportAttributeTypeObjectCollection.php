 ...
 */
class AttributeTypeObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeTypeObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeTypeObjectCollection $proxy) {
