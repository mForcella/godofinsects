 ...
 */
class PublishCompleteEntry extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\PublishCompleteEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'timestamp', 'log', 'object'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PublishCompleteEntry $proxy) {
