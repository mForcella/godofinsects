 ...
 */
class ConfigValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\Object\ConfigValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'config_key', 'id', 'entry'];
        }
