 ...
 */
class PageTemplateObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageTemplateObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['templates' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'templates', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageTemplateObjectCollection $proxy) {
