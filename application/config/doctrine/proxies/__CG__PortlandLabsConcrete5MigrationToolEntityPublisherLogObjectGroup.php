 ...
 */
class Group extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\Object\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'path', 'id', 'entry'];
        }
