 ...
 */
class AttributeKeyControl extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Express\AttributeKeyControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'attribute_key', 'id', 'field_set', 'is_required', 'position', 'custom_label'];
        }
    ...
    public function getControlPublisher()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getControlPublisher', []);

        return parent::getControlPublisher();
    }
