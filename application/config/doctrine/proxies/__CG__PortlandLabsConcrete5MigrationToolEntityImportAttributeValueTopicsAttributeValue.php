 ...
 */
class TopicsAttributeValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeValue\TopicsAttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TopicsAttributeValue $proxy) {
    ...
    public function setValue($topics_value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue', [$topics_value]);

        return parent::setValue($topics_value);
    }
