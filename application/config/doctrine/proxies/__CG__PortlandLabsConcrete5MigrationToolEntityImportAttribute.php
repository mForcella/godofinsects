 ...
 */
class Attribute extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Attribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'handle', 'attribute_value'];
        }
    ...
    public function setAttributeValue($attribute_value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAttributeValue', [$attribute_value]);

        return parent::setAttributeValue($attribute_value);
    }
