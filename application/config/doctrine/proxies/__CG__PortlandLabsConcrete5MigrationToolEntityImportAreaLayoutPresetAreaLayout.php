 ...
 */
class PresetAreaLayout extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AreaLayout\PresetAreaLayout implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'preset', 'id', 'block_value', 'columns'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PresetAreaLayout $proxy) {
