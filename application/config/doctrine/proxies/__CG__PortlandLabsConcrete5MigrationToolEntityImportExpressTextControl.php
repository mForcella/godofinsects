 ...
 */
class TextControl extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Express\TextControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'headline', 'body', 'id', 'field_set', 'is_required', 'position', 'custom_label'];
        }
