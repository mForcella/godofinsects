 ...
 */
class BannedWord extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BannedWord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'word'];
        }
