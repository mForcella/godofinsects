 ...
 */
class ConfigValueObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\ConfigValueObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['values' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'values', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConfigValueObjectCollection $proxy) {
