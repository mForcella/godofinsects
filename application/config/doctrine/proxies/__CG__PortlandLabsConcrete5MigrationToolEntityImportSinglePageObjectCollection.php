 ...
 */
class SinglePageObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\SinglePageObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['pages' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'pages', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SinglePageObjectCollection $proxy) {
