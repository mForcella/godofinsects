 ...
 */
class EntryObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\Express\EntryObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['entries' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entries', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EntryObjectCollection $proxy) {
