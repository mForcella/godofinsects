 ...
 */
class ExpressAttributeKeyCategoryInstance extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\ExpressAttributeKeyCategoryInstance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entity_handle', 'id', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExpressAttributeKeyCategoryInstance $proxy) {
    ...
    public function getEntityHandle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEntityHandle', []);

        return parent::getEntityHandle();
    }
    ...
    public function setEntityHandle($entity_handle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEntityHandle', [$entity_handle]);

        return parent::setEntityHandle($entity_handle);
    }
