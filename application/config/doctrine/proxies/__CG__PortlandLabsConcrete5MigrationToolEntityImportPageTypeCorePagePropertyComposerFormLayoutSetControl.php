 ...
 */
class CorePagePropertyComposerFormLayoutSetControl extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageType\CorePagePropertyComposerFormLayoutSetControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CorePagePropertyComposerFormLayoutSetControl $proxy) {
