 ...
 */
class GroupObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\GroupObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['groups' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'groups', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupObjectCollection $proxy) {
