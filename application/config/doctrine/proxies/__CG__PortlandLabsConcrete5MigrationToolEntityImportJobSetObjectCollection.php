 ...
 */
class JobSetObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\JobSetObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JobSetObjectCollection $proxy) {
