 ...
 */
class Message extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'message', 'log'];
        }
