 ...
 */
class SiteObjectCollection extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\SiteObjectCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['sites' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'sites', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SiteObjectCollection $proxy) {
    ...
    public function setSites($sites)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSites', [$sites]);
