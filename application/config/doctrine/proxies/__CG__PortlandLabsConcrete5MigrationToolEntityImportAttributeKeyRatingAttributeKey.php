 ...
 */
class RatingAttributeKey extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\RatingAttributeKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RatingAttributeKey $proxy) {
