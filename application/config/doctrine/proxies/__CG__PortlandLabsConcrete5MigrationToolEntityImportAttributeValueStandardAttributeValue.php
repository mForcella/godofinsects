 ...
 */
class StandardAttributeValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeValue\StandardAttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StandardAttributeValue $proxy) {
    ...
    public function setValue($standard_value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue', [$standard_value]);

        return parent::setValue($standard_value);
    }
