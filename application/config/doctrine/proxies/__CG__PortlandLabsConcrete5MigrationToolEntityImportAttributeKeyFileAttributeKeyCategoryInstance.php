 ...
 */
class FileAttributeKeyCategoryInstance extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\FileAttributeKeyCategoryInstance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FileAttributeKeyCategoryInstance $proxy) {
