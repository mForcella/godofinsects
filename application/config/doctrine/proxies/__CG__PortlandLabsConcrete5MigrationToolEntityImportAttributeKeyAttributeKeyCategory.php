 ...
 */
class AttributeKeyCategory extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeKey\AttributeKeyCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'handle', 'allow_sets', 'package'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeKeyCategory $proxy) {
    ...
    public function getAllowSets()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAllowSets', []);

        return parent::getAllowSets();
    }
    ...
    public function setAllowSets($allow_sets)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAllowSets', [$allow_sets]);

        return parent::setAllowSets($allow_sets);
    }
