 ...
 */
class AllPagesPublishTarget extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\PageType\AllPagesPublishTarget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'form_factor', 'id', 'type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AllPagesPublishTarget $proxy) {
