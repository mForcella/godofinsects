 ...
 */
class ThemeGridAreaLayout extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AreaLayout\ThemeGridAreaLayout implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'max_columns', 'id', 'block_value', 'columns'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ThemeGridAreaLayout $proxy) {
    ...
    public function getMaxColumns()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMaxColumns', []);

        return parent::getMaxColumns();
    }
    ...
    public function setMaxColumns($max_columns)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMaxColumns', [$max_columns]);

        return parent::setMaxColumns($max_columns);
    }
