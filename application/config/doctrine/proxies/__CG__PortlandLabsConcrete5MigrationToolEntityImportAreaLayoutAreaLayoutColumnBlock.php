 ...
 */
class AreaLayoutColumnBlock extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AreaLayout\AreaLayoutColumnBlock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'area', 'column', 'id', 'type', 'name', 'custom_template', 'block_value', 'style_set', 'position', 'defaults_output_identifier'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AreaLayoutColumnBlock $proxy) {
