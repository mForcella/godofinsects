 ...
 */
class ImageSliderBlockValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\BlockValue\ImageSliderBlockValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['records' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'records', 'id', 'block'];
        }

        return ['__isInitialized__', 'id', 'block'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageSliderBlockValue $proxy) {
    ...
    public function setRecords($records)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRecords', [$records]);

        return parent::setRecords($records);
    }
