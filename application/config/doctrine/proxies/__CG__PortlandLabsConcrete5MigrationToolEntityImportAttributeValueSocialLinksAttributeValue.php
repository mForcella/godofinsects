 ...
 */
class SocialLinksAttributeValue extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\AttributeValue\SocialLinksAttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SocialLinksAttributeValue $proxy) {
    ...
    public function setValue($links_value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue', [$links_value]);

        return parent::setValue($links_value);
    }
