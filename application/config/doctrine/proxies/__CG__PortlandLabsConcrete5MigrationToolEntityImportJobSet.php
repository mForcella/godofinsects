 ...
 */
class JobSet extends \PortlandLabs\Concrete5\MigrationTool\Entity\Import\JobSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'collection', 'name', 'package', 'jobs'];
        }
