 ...
 */
class FatalErrorEntry extends \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\FatalErrorEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'message', 'filename', 'line', 'id', 'timestamp', 'log', 'object'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FatalErrorEntry $proxy) {
    ...
    public function getEntryFormatter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEntryFormatter', []);

        return parent::getEntryFormatter();
    }
